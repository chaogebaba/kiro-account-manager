    ...
    <div className={`h-full flex flex-col items-center justify-center ${colors.main} relative overflow-hidden`}>
      ...
      <div className="relative z-10 w-full max-w-sm px-6">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className={`w-16 h-16 rounded-2xl ${isDark ? 'bg-gradient-to-br from-purple-500 to-blue-600' : 'bg-gradient-to-br from-purple-400 to-blue-500'} flex items-center justify-center mb-4 shadow-lg shadow-purple-500/25`}>
        ...
        {/* Footer */}
        <p className={`mt-10 text-xs ${colors.textMuted} text-center leading-relaxed`}>
          登录即表示同意{' '}
