          ...
          <div className={`${colors.card} rounded-2xl w-[400px] shadow-2xl`} onClick={e => e.stopPropagation()}>
            ...
            <div className="p-5 space-y-3">
              ...
              <button
                ...
                disabled={addLoading}
                className={`group w-full relative flex items-center justify-center gap-3 px-4 py-3 ${colors.loginBtn} border hover:border-purple-500 rounded-lg transition-all disabled:opacity-50`}
              >
                ...
                <span className={`absolute right-4 ${colors.text} opacity-0 group-hover:opacity-100 transition-opacity text-sm`}>Sign in →</span>
              </button>
              ...
              <button
                ...
                className={`group w-full relative flex items-center justify-center gap-3 px-4 py-3 ${colors.loginBtn} border hover:border-purple-500 rounded-lg transition-all disabled:opacity-50`}
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill={colors.loginBtnIcon}>
              ...
              <button
                ...
                disabled={addLoading}
                className={`group w-full relative flex items-center justify-center gap-2 px-4 py-3 ${colors.loginBtn} border hover:border-purple-500 rounded-lg transition-all disabled:opacity-50`}
              >
