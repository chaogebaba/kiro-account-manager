...
const en = {
  ...
  addAccount: {
    ...
    social: {
      ...
      browserHint: 'Copy the login URL below, open it in a browser of your choice and sign in. This window returns automatically.',
      loginUrl: 'Login URL',
      copyUrl: 'Copy login link',
      copied: 'Copied to clipboard',
      expiresIn: 'Expires in {seconds}s',
      remoteTitle: 'Browser on another machine?',
      remoteHint: 'Paste the full callback address the browser landed on, e.g. http://127.0.0.1:3128/oauth/callback?code=...&state=...',
      remotePlaceholder: 'http://127.0.0.1:3128/oauth/callback?code=...&state=...',
      remoteSubmit: 'Finish login',
      syncAfterLogin: 'Set as current account after login (sync to kiro-cli / Kiro IDE)'
    },
    batch: {
      title: 'Batch Import',
  ...
  errors: {
    ...
    SOCIAL_LOGIN_PORTS_BUSY: 'All local callback ports are in use. Close whatever is holding 3128 / 4649 / 6588 / 8008 / 9091 and try again.',
    SOCIAL_LOGIN_EXPIRED: 'The login window expired (10 minutes). Please start over.',
    SOCIAL_LOGIN_STATE_MISMATCH: 'OAuth state did not match, the callback was rejected. Please start over.',
    SOCIAL_LOGIN_EXCHANGE_FAILED: 'Failed to exchange the authorization code for a token',
    SOCIAL_LOGIN_NO_REFRESH_TOKEN: 'The login returned no refreshToken, so the account cannot be kept signed in. Please try again.',
    SOCIAL_LOGIN_CANCELLED: 'Login was cancelled',
